...
<?php $__env->startSection('content'); ?>
    ...
    <form action="/VagonuDati/<?php echo e($vagonudati->DatuID); ?>/editSubmit" method="POST">
        <?php echo csrf_field(); ?>
        <div class="form-group">
            <label for="NomasID">Nomas ID:</label>
            <input type="text" class="form-control" id="NomasID" name="NomasID" value="<?php echo e($vagonudati->NomasID); ?>" required>
        </div>

        <div class="form-group">
            <label for="VagonaID">Vagona ID:</label>
            <input type="text" class="form-control" id="VagonaID" name="VagonaID" value="<?php echo e($vagonudati->VagonaID); ?>" required>
        </div>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\tinyd\Herd\ccargo\resources\views/VagonuDatuEdit.blade.php ENDPATH**/ ?>