...
<head>
    ...
    <style>
        ...
        .card { width: 400px; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); } 
        .btn-bloom { background-color: #59c1cf; color: #ffffff; border: none; border-radius: 8px; padding: 10px; font-size: 16px; } 
        .btn-bloom:hover { background-color: #59c1cf; } 
    </style>
</head>
