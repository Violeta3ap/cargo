            ...
            <td>
                <div style="display: flex; flex-direction: column; gap: 5px; align-items: center;">
                    ...
                    @if(Auth::check() && (($item->PabeigsanasStatuss ?? null) !== 'Pabeigts'))
                        <a href="/Noma/{{ $item->NomasID }}/delete" onclick="return confirm('Vai tiešām vēlies dzēst šo ierakstu?');" class="btn-action" style="border-color:#bb6552; background-color:#bb6552;">Dzēst</a>
                    @endif
                </div>
            </td>
          </tr>
