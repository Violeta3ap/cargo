@extends('layout.app')<!-- Paplašina galveno layout failu 'layout.app' -->
 ...
 @section('content')<!-- Satura sadaļas sākums -->
  <h2>Rediģēt nomu</h2>
   <a href="/Noma" style="border-radius:8px; border: 1px solid #59c1cf; padding: 5px; color:
    #000000; text-decoration: none; background: linear-gradient(to right, #59c1cf, #ffffff)">Atpakaļ</a><!-- Poga atpakaļ uz nomas sarakstu -->
  ...
  <div class="form-group"> 
    ...
    <!-- Nosūtīšanas stacija -->
            ...
            <button type="submit" style="border-radius:8px; border: 1px solid #59c1cf;
             padding: 5px; color: #000000; text-decoration: none; background: linear-gradient(to right,
              #59c1cf, #ffffff)">Atjaunināt
            ...
            <!-- CSS stili -->
            <style> .form-group { margin-bottom: 20px; }  <!-- Atstarpes starp formām -->
            ...
            .form-control:focus { outline: none; border-color: #59c1cf; box-shadow: 0 0 5px rgba(89, 193, 207, 0.3); }<!-- Ievades lauka stils -->
            
            button[type="submit"] { cursor: pointer; font-size: 16px; font-weight: 500; transition: transform 0.2s; }<!-- Fokusa efekts -->
            
            button[type="submit"]:hover { transform: scale(1.05); }<!-- Poga stilizēšana -->
