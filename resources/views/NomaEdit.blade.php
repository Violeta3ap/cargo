...
@section('content')
    ...
    <form action="/Noma/{{ $noma->NomasID }}/editSubmit" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="VagonuSkaits" name="VagonuSkaits" value="{{ $noma->VagonuSkaits }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="KopejaMaksa" name="KopejaMaksa" value="{{ $noma->KopejaMaksa }}" required>
        </div>
