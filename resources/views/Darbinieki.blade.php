            ...
            @if(Auth::check() && !Auth::user()->isDarbinieks())
                <td>
                    ...
                    <div style="display: flex; gap: 5px; justify-content: center; flex-wrap: wrap;">
                        ...
                        <a href="/Darbinieki/{{ $item->DarbiniekaID }}/delete" onclick="return confirm('Vai tiešām vēlies dzēst šo ierakstu?');" class="btn-action" style="border-color:#bb6552; background-color:#bb6552;">Dzēst</a>
                    </div>
                </td>
            @endif
        </tr>
