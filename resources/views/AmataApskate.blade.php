...
@section('content') <!-- Saturu daļa, kas tiks ielādēta layout -->
    ...
    <!-- Poga amata dzēšanai -->
    <a href="/Amati/{{ $amati->AmataID }}/delete" class="js-confirm-action" data-confirm-title="Dzēst ierakstu?" data-confirm-message="Vai tiešām vēlaties dzēst šo ierakstu? Šo darbību nevarēs atsaukt." data-confirm-button="Jā, dzēst" style="border-radius:8px; border: 1px solid #b62100; 
