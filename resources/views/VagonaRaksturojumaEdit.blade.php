...
@section('content')
    ...
    <form action="/VagonaRaksturojums/{{ $vagonaraksturojums->VagonaID }}/editSubmit" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="VeidaID" name="VeidaID" value="{{ $vagonaraksturojums->VeidaID }}" required>
        </div>

        <div class="form-group">
            <label for="KravasID">Kravas ID:</label>
            <input type="text" class="form-control" id="KravasID" name="KravasID" value="{{ $vagonaraksturojums->KravasID }}" required>
        </div>

        <div class="form-group">
            <label for="Celtspeja">Celtspeja:</label>
            <input type="text" class="form-control" id="Celtspeja" name="Celtspeja" value="{{ $vagonaraksturojums->Celtspeja }}" required>
        </div>
