...
<form action="/Kravas/{{ $kravas->KravasID }}/editSubmit" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="Nosaukums" name="Nosaukums" value="{{ $kravas->Nosaukums }}" maxlength="30" pattern="[A-Za-zĀ-ž ]+" title="Drīkst ievadīt tikai burtus un atstarpes." required>
    </div>
