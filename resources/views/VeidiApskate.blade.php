...
<a href="/Veidi/{{ $veidi->VeidaID }}/edit" style="border-radius:8px; border: 1px solid #C2CBD1; 
    padding: 5px; color: #000000; text-decoration: none; background: linear-gradient(to right, #C2CBD1, #ffffff)">
    Rediģēt
</a> <!-- Poga veida rediģēšanai -->

<a href="/Veidi/{{ $veidi->VeidaID }}/delete" class="js-confirm-action" data-confirm-title="Dzēst ierakstu?" data-confirm-message="Vai tiešām vēlaties dzēst šo ierakstu? Šo darbību nevarēs atsaukt." data-confirm-button="Jā, dzēst" style="border-radius:8px; border: 1px solid #b62100; 
